    ...
    <div className="box">
      ...
      <form action="">
        <div className="inputbox">
          ...
          />
          <label htmlFor="email">E-mail address or Phone number</label>
        </div>
        <div className="inputbox">
          <input
            type="password"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M19 12c0-2.76-3.58-5-8-5s-8 2.24-8 5 3.58 5 8 5 8-2.24 8-5zm-8-3a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>
            <path d="M12 19l-4 4"/>
            <path d="M12 19l4 4"/>
          </svg>
        </div>
